          ...
          <TracingBeam className="px-6">
            <div className="max-w-4xl mx-auto antialiased pt-4 relative">
              ...
              >
                ...
                />
                <h2 className="text-2xl font-bold text-lift-text-primary mb-4">About Me</h2>
              ...
              <motion.div variants={fadeInUp}>
                <h2 className="text-2xl font-bold text-lift-text-primary mb-6">Skills</h2>
                  ...
                  {skills.map((skill, index) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-lift-text-primary">{skill.name}</h3>
                          <p className="text-lift-text-secondary">{skill.description}</p>
                        </div>
                      </div>
                    </motion.div>
                  ))}
