  ...
  const programs = [
    {
      ...
      description: 'Master essential financial skills through our comprehensive curriculum covering budgeting, saving, investing, and financial planning.',
      features: [
    ...
    },
    {
      ...
      description: 'Develop professional skills and prepare for your future career with our comprehensive career development program.',
      features: [
        ...
        <Container>
          ...
          >
            ...
            >
              ...
              with essential life skills and professional development opportunities.
            </motion.p>
          </motion.div>
        </Container>
      </section>
                ...
                <div className="text-center">
                  ...
                  <ul className="text-left space-y-2 mb-6">
                    {program.features.map((feature, i) => (
                      <li key={i} className="flex items-center text-lift-text-secondary">
      ...
      <section className="py-20 bg-lift-accent">
        <Container>
          ...
          >
            ...
            >
              Join our programs today and take the first step towards a brighter future.
