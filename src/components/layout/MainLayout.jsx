          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0 flex items-center">
                <span className="text-lift-blue text-2xl font-bold">
                  L.I.F.T.
                </span>
              </Link>
            </div>
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="text-lift-text-secondary hover:text-lift-blue"
              >
                <svg
                  className="h-6 w-6"
                  fill="none"
      ...
      <footer className="bg-lift-blue text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-8 pt-8 border-t border-white/10 text-center text-gray-300">
            <p>
              &copy; {new Date().getFullYear()} L.I.F.T. All rights reserved.
            </p>
